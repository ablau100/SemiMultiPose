...
#weight_p = 'training_dir/250/standard_small_im_lr_2dl/0/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0005000.pth'
...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'bee', \
        'OUTPUT_DIR', 'training_dir/' + number_data + '/three_batch/' + loss_type + '_res' +str(alpha)+'/' +version + '/fcos_kps_ms_training_R_50_FPN_1x_bee', \
        ...
        'MODEL.WEIGHT', 'training_dir/25/standard_res1/1/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0002500.pth', \
