...
weight_p = 'training_dir/'+ number_data + '/redo/p3u'+loss_type +'_res/'+version + '/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0004000.pth'
original = torch.load(weight_p)
new_m = {"model": original["model"]}
torch.save(new_m, 'training_dir/250/f5'+ alpha +beta+ version+ '_model_0500.pth')
    
config_file = "/home/ec2-user/directpose/configs/fcos/fcos_kps_ms_training_R_50_FPN_1x.yaml"
cfg.merge_from_file(config_file)
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'bee', \
        'OUTPUT_DIR', 'training_dir/' + number_data + '/redo/p4u' + loss_type + '_res/' + version +'/fcos_kps_ms_training_R_50_FPN_1x_bee', \
        ...
        'MODEL.WEIGHT', 'training_dir/250/f5'+ alpha +beta+ version+ '_model_0500.pth', \
