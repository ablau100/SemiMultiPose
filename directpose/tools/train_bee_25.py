...
if version == "0":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
            ...
            'DATASETS.TRAIN', "('bee_25_v0_train_cocostyle', 'bee_25_v0_train_cocostyle')"
            ])
...
if version == "1":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
            ...
            'SOLVER.MAX_ITER', 180000, \
            'MODEL.HEATMAPS_LOSS_WEIGHT', 4.0, \
            'DATASETS.TRAIN', "('bee_25_v1_train_cocostyle', 'bee_25_v1_train_cocostyle')"
            ])
...
if version == "2":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
            ...
            'SOLVER.MAX_ITER', 180000, \
            'MODEL.HEATMAPS_LOSS_WEIGHT', 4.0, \
            'DATASETS.TRAIN', "('bee_25_v2_train_cocostyle', 'bee_25_v2_train_cocostyle')"
            ])
...
if version == "3":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
            ...
            'SOLVER.MAX_ITER', 180000, \
            'MODEL.HEATMAPS_LOSS_WEIGHT', 4.0, \
            'DATASETS.TRAIN', "('bee_25_v3_train_cocostyle', 'bee_25_v3_train_cocostyle')"
            ])
