...
weight_p = 'training_dir/25/redo/p2'+loss_type +'_res'+str(alpha)+'/'+version + '/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0006000.pth'
...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'bee', \
        'OUTPUT_DIR', 'training_dir/' + number_data + '/redo/' + loss_type + '_res_untf5f_bets'+beta + alpha+'/' + version +'/fcos_kps_ms_training_R_50_FPN_1x_bee', \
