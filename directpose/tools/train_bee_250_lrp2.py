...
weight_p = 'training_dir/25/beta_test/combined_res.1/'+version + '/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0005000.pth'
original = torch.load(weight_p)
new_m = {"model": original["model"]}
torch.save(new_m, 'training_dir/250/standard_track_f75/model_0500.pth')
...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'bee', \
        'OUTPUT_DIR', 'training_dir/' + number_data + '/beta_test/' + loss_type + '_res_f5_test_.001_beta' + str(beta) + '/' + version +'/fcos_kps_ms_training_R_50_FPN_1x_bee', \
        ...
        'MODEL.WEIGHT', 'training_dir/250/standard_track_f75/model_0500.pth', \
