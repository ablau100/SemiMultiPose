...
#     assert is_pytorch_1_1_0_or_later()
    ...
    weight_p = 'training_dir/250/combined_fs_w_/.001/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0002500.pth'
    original = torch.load(weight_p)
    new_m = {"model": original["model"]}
    torch.save(new_m, 'training_dir/250/combined_fs_w_/.001/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0002500.pth')
...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'bee', \
        'OUTPUT_DIR', 'training_dir/' + number_data + '/' + loss_type + '_fs_fc_un_2/' + alpha +'/fcos_kps_ms_training_R_50_FPN_1x_bee', \
        ...
        'MODEL.WEIGHT', 'training_dir/250/combined_fs_w_/.001/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0002500.pth', \
        ...
        'DATASETS.TRAIN', "('beeua_train_cocostyle', 'beeua_train_cocostyle')"
        ])
