...
weight_p = 'training_dir/pups/p2call/combined/'+ version + '/fcos_kps_ms_training_R_50_FPN_1x_pup/model_0002000.pth'
...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'pup', \
        'OUTPUT_DIR', 'training_dir/pups/p3ccc' + number_data + '/' + loss_type  +'/' +version + '/fcos_kps_ms_training_R_50_FPN_1x_pup', \
