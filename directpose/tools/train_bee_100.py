...
#     assert is_pytorch_1_1_0_or_later()
    ...
    extra_checkpoint_data = checkpointer.load(None)#cfg.MODEL.WEIGHT
...
if version == "0":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                         'DATATYPE', 'bee', \
            'OUTPUT_DIR', 'training_dir/' + number_data + '/' +version + '/' + loss_type + '/fcos_kps_ms_training_R_50_FPN_1x_bee', \
            ...
            'DATASETS.TRAIN', "('bee_100_v0_train_cocostyle', 'bee_100_v0_train_cocostyle')"
            ])
...
if version == "1":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
            ...
            'SOLVER.MAX_ITER', 180000, \
            'MODEL.HEATMAPS_LOSS_WEIGHT', 4.0, \
            'DATASETS.TRAIN', "('bee_100_v1_train_cocostyle', 'bee_100_v1_train_cocostyle')"
            ])
...
if version == "2":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
            ...
            'SOLVER.MAX_ITER', 180000, \
            'MODEL.HEATMAPS_LOSS_WEIGHT', 4.0, \
            'DATASETS.TRAIN', "('bee_100_v2_train_cocostyle', 'bee_100_v2_train_cocostyle')"
            ])
...
if version == "3":
    ...
    cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
            ...
            'SOLVER.MAX_ITER', 180000, \
            'MODEL.HEATMAPS_LOSS_WEIGHT', 4.0, \
            'DATASETS.TRAIN', "('bee_100_v3_train_cocostyle', 'bee_100_v3_train_cocostyle')"
            ])
