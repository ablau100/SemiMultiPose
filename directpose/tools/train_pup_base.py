...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'pup', \
        'OUTPUT_DIR', 'training_dir/pups/' + number_data + '/' + loss_type  +'/' +version + '/fcos_kps_ms_training_R_50_FPN_1x_pup', \
        ...
        'MODEL.WEIGHT', 'training_dir/pup/all/standard/'+version+'/fcos_kps_ms_training_R_50_FPN_1x_pup/model_0002000.pth', \
