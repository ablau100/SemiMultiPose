...
weight_p = 'training_dir/25/beta_test/'+str(loss_type) + '_res_f5_test_.001_beta'+ beta + '/'+str(version)+'/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0001500.pth'
original = torch.load(weight_p)
new_m = {"model": original["model"]}
torch.save(new_m, 'training_dir/250/combined_track_f75_p2/model_00900000.pth')
...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'bee', \
        'OUTPUT_DIR', 'training_dir/' + number_data + '/beta_test/' + loss_type + '_res_f65_test_.0003_beta' + str(beta) + '/' + version +'/fcos_kps_ms_training_R_50_FPN_1x_bee', \
        ...
        'MODEL.WEIGHT', 'training_dir/250/combined_track_f75_p2/model_00900000.pth', \
...
#weight_p = 'training_dir/250/combined_test_lr_f75_.001/0/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0005000.pth'
#original = torch.load(weight_p)
#new_m = {"model": original["model"]}
#torch.save(new_m, 'training_dir/250/combined_track_f75_.001_p2/model_0005000.pth')
