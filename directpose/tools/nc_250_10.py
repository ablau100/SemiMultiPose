...
#weight_p = 'training_dir/25/full_batch/standard_res0/1.8/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0005000.pth'
#original = torch.load(weight_p)
#new_m = {"model": original["model"]}
#torch.save(new_m, 'training_dir/250/standard_track_f25/model_0500.pth')
...
cfg.merge_from_list(['DATALOADER.NUM_WORKERS', 2, \
                     'DATATYPE', 'bee', \
        'OUTPUT_DIR', 'training_dir/' + number_data + '/newloss/p2' + loss_type + '_res' +'/' +version + '/fcos_kps_ms_training_R_50_FPN_1x_bee', \
        ...
        'MODEL.WEIGHT', 'training_dir/' +number_data+'/standard_res0/'+version+'/fcos_kps_ms_training_R_50_FPN_1x_bee/model_0002000.pth', \
