...
#             cl = cl/N_kps
    ...
    def forward(
        ...
        """
        #print("THe real coords")
        #print(heatmaps_coords)
        ...
        if 0:#self.centroid:
            print("uhh guess 0 is true?")
            boxlists = self.select_over_all_levels_centroids(sampled_boxes)
        else:
            #print("or not")
            #print("SAMP BOXES", sampled_boxes)
            boxlists = list(zip(*sampled_boxes))
            #print("POST LIST", boxlists)
            boxlists = [cat_boxlist(boxlist) for boxlist in boxlists]
            #print("Post CAT BOX", boxlists)
            boxlists = self.select_over_all_levels(boxlists)
        #print("SELECTED BOXES?", boxlists)
