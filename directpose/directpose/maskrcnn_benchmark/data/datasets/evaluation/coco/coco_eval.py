...
def evaluate_predictions_on_coco(
    coco_gt, coco_results, json_result_file, iou_type="bbox", datatype='bee',
):
    import json
    ...
    print("coco_gt",coco_gt) #ground truth
    print("coco_dt",coco_dt) # predictions
